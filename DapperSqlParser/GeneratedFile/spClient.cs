...
namespace ShopParserApi.Services.GeneratedClientFile
{
    ...
    public class Sp_AddCompanyInput
    {
        ...
        [JsonProperty("SyncDate")] public DateTime SyncDate { get; set; }

        [JsonProperty("JsonData")] public string JsonData { get; set; }

        [JsonProperty("JsonDataSchema")] public string JsonDataSchema { get; set; }

        [JsonProperty("CompanyState")] public int CompanyState { get; set; }
    }
    ...
    public class Sp_AddCompany
    {
        ...
        public Task Execute(Sp_AddCompanyInput request)
        {
    ...
    public class Sp_UpdateProductInput
    {
        ...
        [JsonProperty("productState")] public int ProductState { get; set; }
    ...
    public class Sp_UpdateProduct
    {
        ...
        public Task Execute(Sp_UpdateProductInput request)
        {
    ...
    public class Sp_UpdateProductState
    {
        ...
        public Task Execute(Sp_UpdateProductStateInput request)
        {
